...
<div class="container segment" id="about-us">
    <section id="process">
        <h1>За Нас</h1>
        <div class="row">
            <div class="col-md-8">
...
<div class="container segment" id="our-services">
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <section id="contact">
                    ...
                    <p>
                        <address>
                            <strong>БЦ Стил</strong><br>
                            Октомвриска Револуција 11<br>
                            1300 Куманово, <abbr title="Македонија">MK</abbr><br>
                            <?=mungemail('info@bcsteel.mk')?><br>
                            +389 31 453 905<br>
                            +389 70 799 701
                        </address>
                    </p>
            ...
            <div class="col-md-6">
                <section>
                    <div id="googleMapCanvas" class="google-maps"></div>
                </section>
                <?php
